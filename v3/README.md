...
### How to use themes
1. Click [Themes](https://github.com/beeper/themes/tree/main/v3/themes) -> select the theme you would like to try
...
View [variables.scss](https://github.com/beeper/themes/tree/main/v3/variables.scss) for all default values.
